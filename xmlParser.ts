...
export class XmlParser {
    ...
    parseElement(): XmlElement {
        ...
        while (this.pos < this.input.length && !this.startsWithAny([">", "/>"])) {
            ...
            attributes.push(new XmlAttribute(leadingWs, attrName, wsBeforeEqual, wsAfterEqual, quote, value));
        }
        // End of open tag.
        ...
        return new XmlElement(tagName, attributes, attrTrailingWs, selfClosing, children, closeTagWs);
    }
